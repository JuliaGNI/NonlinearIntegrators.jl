...
@testset "ShallowNetAutodiffReversible accuracy ($T)" for T in TEST_TYPES
    ...
    @debug "ShallowNetAutodiffReversible ($T)" q_end=Float64(qend) q_ref=Float64(ref) abs_err=err
