...
# parameter T, so this test is restricted to Float64. The `integrate` call for
# PR_Integrator returns a 3-tuple (sol, internal_values, x_list) because of the
# custom integrate! override in PR_Int.jl.
#
