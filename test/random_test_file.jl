...
GeometricIntegratorsBase.default_options(method::Time_reversible_OneLayer) = (
    ...
    f_abstol = 4.440892098500626e-16,
...
log_file="NVI_HO_h$(int_step)S$(S)R$(R)reluk=$(k_relu)2.txt"
record_results = Dict()
...
open(log_file, "w") do io
    redirect_stdio(stdout=log_file, stderr=log_file) do
        ...
        save("NVI_HO_h$(int_step)S$(S)R$(R)reluk=$(k_relu)2.jld2",record_results)
        ...
        savefig(p, "NVI_HO_h$(int_step)S$(S)R$(R)reluk=$(k_relu)2.pdf")
    end
end