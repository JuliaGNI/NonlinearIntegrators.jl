...
PRB = PR_Basis{Float64}([q₁_expr, q₂_expr, q₃_expr, q₄_expr, q₅_expr, q₆_expr], [W1, W2, W3, W4, W5, W6],ttt,6)
R = 8
QGau = QuadratureRules.GaussLegendreQuadrature(R)
PR_Int = PR_Integrator(PRB, QGau,[[-0.25275,0.7854,0.08030715,0.71809],
...
TL_PR_sol,TL_internal_sol,TL_x_list = integrate(TL_lode, PR_Int)
