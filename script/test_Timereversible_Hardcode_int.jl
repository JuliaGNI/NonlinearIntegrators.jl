...
GeometricIntegratorsBase.default_options(method::Time_Reversible_Hardcode) = (
    ...
    for S in S_list
        # for k_relu in k_list
            try
                ...
                NLOLCGVNI_Gml = Time_Reversible_Hardcode(OLnetwork, QGau, show_status = false, bias_interval = [-pi,pi], dict_amount = 400000)
