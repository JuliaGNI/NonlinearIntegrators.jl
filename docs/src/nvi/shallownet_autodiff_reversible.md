...
<!-- max error table (generated by result_summary_shallownet_autodiff_reversible.jl) -->

![Relative Hamiltonian error over time — best ReLU run](figures/shallownet_autodiff_reversible_HO_relu_hamiltonian_error_ts.png)
...
![Relative Hamiltonian error over time — best tanh run](figures/shallownet_autodiff_reversible_HO_tanh_hamiltonian_error_ts.png)
...
![Relative Hamiltonian error over time — best ReLU run](figures/shallownet_autodiff_reversible_DP_relu_hamiltonian_error_ts.png)
...
![Relative Hamiltonian error over time — best tanh run](figures/shallownet_autodiff_reversible_DP_tanh_hamiltonian_error_ts.png)
