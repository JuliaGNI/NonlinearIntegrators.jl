...
![Min-Max Hamiltonian error from fewest unconverged runs (ReLU)](figures/shallownet_autodiff_reversible_HO_relu_fewest_error_trend.png)
...
![Min-Max Hamiltonian error from fewest unconverged runs (tanh)](figures/shallownet_autodiff_reversible_HO_tanh_fewest_error_trend.png)
...
![Min-Max Hamiltonian error from fewest unconverged runs (ReLU)](figures/shallownet_autodiff_reversible_DP_relu_fewest_error_trend.png)
...
![Min-Max Hamiltonian error from fewest unconverged runs (tanh)](figures/shallownet_autodiff_reversible_DP_tanh_fewest_error_trend.png)
