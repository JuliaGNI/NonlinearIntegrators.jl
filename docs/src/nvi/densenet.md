...
![Min-Max Hamiltonian error from fewest unconverged runs (ReLU)](figures/densenet_HO_relu_fewest_error_trend.png)
...
![Min-Max Hamiltonian error from fewest unconverged runs (tanh)](figures/densenet_HO_tanh_fewest_error_trend.png)
...
![Min-Max Hamiltonian error from fewest unconverged runs (ReLU)](figures/densenet_DP_relu_fewest_error_trend.png)
...
![Min-Max Hamiltonian error from fewest unconverged runs (tanh)](figures/densenet_DP_tanh_fewest_error_trend.png)
