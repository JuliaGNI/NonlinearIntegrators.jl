__NOTE__: This page is served as a detailed extension of Continuous Galerkin Variational Integrators from  [GeometricIntegrators.jl](https://juliagni.github.io/GeometricIntegrators.jl/stable/integrators/cgvi/#cgvi)
