...
|---|---|---|---|---|
| [`NoSymmetry`](@ref) | 1 | 1 | independent | `NonLinear_OneLayer_GML`, `Hardcode_int` |
| [`MirrorPairs`](@ref) | 2 | 2 | independent | `Time_reversible_OneLayer` |
| [`SharedMirrorPairs`](@ref) | 2 | 1 (their sum) | shared | `Time_Reversible_Hardcode` |
...
`Hardcode_int` and `Time_Reversible_Hardcode` represent the step as
