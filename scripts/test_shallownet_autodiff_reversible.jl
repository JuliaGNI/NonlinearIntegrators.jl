    ...
    for S in S_list
        # for k_relu in k_list
            try
                ...
                nlmethod = ShallowNetAutodiffReversible(net, QGau, show_status = false, bias_interval = [-pi,pi], dict_amount = 400000)
                ...
                save("HC_TR_int/HC_NVI_HO_h$(int_step)S$(S)R$(R)reluk=$(k_relu)LobattoLegendre.jld2",record_results)
            catch e
