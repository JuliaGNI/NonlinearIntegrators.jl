...
run_configuration() {
    ...
    julia --project=script script/test_shallownet_reversible.jl $h $reg_factor &
    
    # julia --project=script scripts/test_shallownet_autodiff.jl $h $f_abs $x_suc &
}
...
#             run_with_limit julia --project=script scripts/run_shallownet.jl $h $f_abs $x_suc  &
#         # run_with_limit julia --project=script scripts/test_shallownet_autodiff.jl $h $f_abs $x_suc
#         done
#     done
# done
