...
begin # h = 1
    ...
    scatter!(p1_axis, t_coarse, vise_sol_p, label="VISE Discrete Solution ", color=:blue)

    hams = [GeometricProblems.HarmonicOscillator.hamiltonian(0, q, p, HO_lode.parameters) for (q, p) in zip(vise_sol_q, vise_sol_p)]
...
begin # h = 2
    ...
    scatter!(p2_axis, t_coarse, vise_sol_p, label="VISE Discrete Solution ", color=:blue)
...
begin # h = 5.0
    ...
    scatter!(p5_axis, t_coarse, vise_sol_p, label="VISE Discrete Solution ", color=:blue)
...
begin # h= 1.0
    ...
    scatter!(q1_axis, t_coarse, vise_sol_q_PPD_h1, label="VISE Discrete Solution", color=:blue)
    vlines!(q1_axis, [30.0], linestyle=:dashdot, color=:purple, label="Training Region")
    ...
    scatter!(p1_axis, t_coarse, vise_sol_p_PPD_h1, label="VISE Discrete Solution ", color=:blue)

    hams = [GeometricProblems.PerturbedPendulum.hamiltonian(0, q, p, PPD_lode.parameters) for (q, p) in zip(vise_sol_q_PPD_h1, vise_sol_p_PPD_h1)]
    initial_hamiltonian = hams[1]
    relative_hams_err = abs.((hams .- initial_hamiltonian) / initial_hamiltonian)# Plot 3: Relative Hamiltonian error
...
begin # h = 2.0
    ...
    scatter!(q2_axis, t_coarse, vise_sol_q_PPD_h2, label="VISE Discrete Solution", color=:blue)
    vlines!(q2_axis, [30.0], linestyle=:dashdot, color=:purple, label="Training Region")
    ...
    scatter!(p2_axis, t_coarse, vise_sol_p_PPD_h2, label="VISE Discrete Solution ", color=:blue)

    hams = [GeometricProblems.PerturbedPendulum.hamiltonian(0, q, p, PPD_lode.parameters) for (q, p) in zip(vise_sol_q_PPD_h2, vise_sol_p_PPD_h2)]
    initial_hamiltonian = hams[1]
    relative_hams_err = abs.((hams .- initial_hamiltonian) / initial_hamiltonian)# Plot 3: Relative Hamiltonian error
    PPD_imp_ham = [GeometricProblems.PerturbedPendulum.hamiltonian(0, q, p, PPD_lode.parameters) for (q, p) in zip(collect(PPD_imp_sol.q[:]), collect(PPD_imp_sol.p[:]))]
    PPD_relative_imp_ham_err = abs.((PPD_imp_ham .- initial_hamiltonian) / initial_hamiltonian)
...
begin # h = 5.0
    ...
    scatter!(q5_axis, t_coarse, vise_sol_q_PPD_h5, label="VISE Discrete Solution", color=:blue)
    ...
    scatter!(p5_axis, t_coarse, vise_sol_p_PPD_h5, label="VISE Discrete Solution ", color=:blue)

    hams = [GeometricProblems.PerturbedPendulum.hamiltonian(0, q, p, PPD_lode.parameters) for (q, p) in zip(vise_sol_q_PPD_h5, vise_sol_p_PPD_h5)]
    initial_hamiltonian = hams[1]
    relative_hams_err = abs.((hams .- initial_hamiltonian) / initial_hamiltonian)# Plot 3: Relative Hamiltonian error
    PPD_imp_ham = [GeometricProblems.PerturbedPendulum.hamiltonian(0, q, p, PPD_lode.parameters) for (q, p) in zip(collect(PPD_imp_sol.q[:]), collect(PPD_imp_sol.p[:]))]
    PPD_relative_imp_ham_err = abs.((PPD_imp_ham .- initial_hamiltonian) / initial_hamiltonian)
...
begin # h= 1.0
    ...
    scatter!(q1_axis, t_coarse, vise_sol_q1, label="VISE Discrete Solution", color=:blue)
    ...
    scatter!(q2_axis, t_coarse, vise_sol_q2, label="VISE Discrete Solution ", color=:blue)
    ...
    scatter!(p1_axis, t_coarse, vise_sol_p1, label="VISE Discrete Solution ", color=:blue)
    ...
    scatter!(p2_axis, t_coarse, vise_sol_p2, label="VISE Discrete Solution ", color=:blue)
    ...
    hams = [HHP_hamiltonian(q1, q2, p1, p2) for (q1, q2, p1, p2) in zip(vise_sol_q1, vise_sol_q2, vise_sol_p1, vise_sol_p2)]
    relative_hams_err = abs.((hams .- initial_hamiltonian) / initial_hamiltonian)# Plot 3: Relative Hamiltonian error
...
sca1 = scatter!(qp_axis, vise_sol_q_PPD_h5, vise_sol_p_PPD_h5, label="VISE Discrete Solution", color=:blue)
